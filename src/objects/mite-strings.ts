//  mite-strings.ts
//  MegaDocker
//  YMl snippets as template strings to build compose files from
...
#Begin Ghost Service Section
 ...
 ghost:
  ...
  environment:
   ...
   - database__connection__password=${ghostRootSQLPassword.value}
 ...
 ghost-mariadb:
  ...
  environment:
   MYSQL_ROOT_PASSWORD=${ghostRootSQLPassword.value}
  deploy:
   restart_policy:
    condition: on-failure
